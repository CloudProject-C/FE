...
// MapService import 경로를 프로젝트에 맞게 수정해주세요.
...
class _ReviewWriteScreenState extends State<ReviewWriteScreen> {
  ...
  int _rating = 0;
  List<XFile> _images = [];
  bool _isLoading = false; // [추가] 로딩 상태 관리
  ...
  Future<void> _submitReview() async {
    ...
    // 3. API 호출
    final success = await MapService.postReview(
    ...
    if (success) {
      ...
      Navigator.pop(context, true); // true를 반환하여 이전 화면 갱신 유도 가능
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Stack( // 로딩 인디케이터 표시를 위해 Stack 사용
        children: [
          Scaffold(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: const BoxDecoration(
                                      color: Colors.white, // 아이콘 배경 흰색으로 변경하여 가시성 확보
                    ...
                    PrimaryButton(
                        text: '리뷰 등록하기',
                        onTap: _isLoading ? () {} : _submitReview, // [수정] 로딩 중 클릭 방지 및 함수 연결
                        height: 48,
